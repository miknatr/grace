...
class DispatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBadBuilderClosure()
    {
        ...
        $this->dispatcher->addSubscriberBuilder('Grace\Test\EventDispatcher\SubscriberBadPlug', function()
            {
    ...
    public function testSubscribingWithClosure()
    {
        ...
        $this->dispatcher->addSubscriberBuilder('Grace\Test\EventDispatcher\SubscriberPlug', function() use ($plug)
            {
                return $plug;
            });
        $this->dispatcher
