...
class UpdateBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testUpdateWithWhereStatement()
    {
        ...
        $this->assertEquals(
            ...
            ' WHERE ?f:alias:.?f=?q AND ?f:alias:.?f BETWEEN ?q AND ?q',
            $this->plug->query
        );
        $this->assertEquals(array('TestTable', 'id', 123, 'name', 'Mike', 'phone', '123-123', 'isPublished', 1, 'category', 10, 20, 'alias' => 'TestTable'), $this->plug->arguments);
    }
}
